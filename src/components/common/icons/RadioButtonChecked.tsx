...
type RadioButtonCheckedProps = { color?: React.CSSProperties['color'] };

const RadioButtonChecked = (props: RadioButtonCheckedProps) => {
  const {} = props;
  ...
  return (
    ...
    >
      ...
      <g mask="url(#mask0_27_167)">
        <path d="M0 0H24V24H0V0Z" fill="#2551F1" />
      </g>
    </svg>
  );
};
